...
module.exports = function() {
    ...
    var obj = {
        ...
        'settings': {
            'get_project_accesses': {
                'get_route_config': function(params) {
                    var route_config = {
                        ...
                        'path': 'projects/' + params.project_id + '/accesses.json',
                        'method': 'get'
                    };
                    return route_config;
                },
                'response_map': {
                    '200': {
                        ...
                        'response_code': '200',
                        'message': 'people who have access to this project'
                    },
                    '301': {
                        'headers': {
                            'Content-Type': 'application/json'
            ...
            'revoke_project_access_by_id': {
                'get_route_config': function(params) {
                    var route_config = {
                        'account_id': params.account_id,
                        'path': 'projects/' + params.project_id + '/accesses/' + params.user_id + '.json',
                        'method': 'delete'
                    };
                    return route_config;
                },
