        ...
        'settings': {
            'get_global_events': {
                'get_route_config': function(params) {
                    ...
                    if(params.since != undefined) {
                        route_config.path = route_config.path + '?since=' + params.since;
                    }
                    if(params.page != undefined) {
                        if(params.since != undefined) {
                            route_config.path = route_config.path + '&page=' + params.page;
                        }
                        else {
                            route_config.path = route_config.path + '?page=' + params.page;
                        }
            ...
            'get_project_events': {
                'get_route_config': function(params) {
                    var route_config = {
                        'account_id': params.account_id,
                        'path': 'projects/' + params.project_id + '/events.json',
                        'method': 'get'
                    };
                    if(params.since != undefined) {
                        route_config.path = route_config.path + '?since=' + params.since;
            ...
            'get_person_events': {
                'get_route_config': function(params) {
                    var route_config = {
                        'account_id': params.account_id,
                        'path': 'people/' + params.user_id + '/events.json',
                        'method': 'get'
                    };
                    if(params.since != undefined) {
                        route_config.path = route_config.path + '?since=' + params.since;
