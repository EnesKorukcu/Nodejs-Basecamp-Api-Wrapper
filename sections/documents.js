        ...
        'settings': {
            'get_documents_by_project_id': {
                'get_route_config': function(params) {
                    var route_config = {
                        ...
                        'path': 'projects/' + params.project_id + '/documents.json',
                        'method': 'get'
                    };
                    return route_config;
                },
                'response_map': {
                    '200': {
                        ...
                        'response_code': '200',
                        'message': 'all documents by project'
                    },
                    '301': {
                        'headers': {
                            'Content-Type': 'application/json'
            ...
            'get_documents': {
                ...
                'response_map': {
                    '200': {
                        ...
                        'response_code': '200',
                        'message': 'all documents by account'
                    },
                    '301': {
                        'headers': {
                            'Content-Type': 'application/json'
            ...
            'get_document_by_document_id': {
                'get_route_config': function(params) {
                    var route_config = {
                        'account_id': params.account_id,
                        'path': 'projects/' + params.project_id + '/documents/' + params.document_id + '.json',
                        'method': 'get'
                    };
                    return route_config;
                },
